...
export default function Checkout({params}) {
  ...
  return (
    <>
    <NavBar />
<div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32 lg:pt-20">
  <div class="px-4 pt-8">
    <p class="text-xl font-medium">Order Summary</p>
    <p class="text-gray-400">Check your items. And select a suitable shipping method.</p>
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6 overflow-auto max-h-96">
      {cart && cart.map((product) => (
        ...
        >
          ...
          <div class="flex w-full flex-col px-4 py-4">
            ...
            <span class="float-right text-gray-400">{product.size}</span>
            <p class="text-lg font-bold">${product.price}</p>
            <button onClick={(e) => {
              e.stopPropagation();
              removeFromCart(product._id);
            }} class="text-primary-400 ml-auto hover:text-primary-600">
              <FaTrash />
            </button>
          </div>
    ...
    <form class="mt-5 grid gap-6">
      <div class="relative">
        ...
        <label class="peer-checked:border-2 peer-checked:border-primary-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_1">
