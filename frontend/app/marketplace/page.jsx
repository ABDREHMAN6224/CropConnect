    ...
    <AuthWrapper>
      ...
      <main className="dark:bg-gray-900 flex">
        <aside className="text-white p-4 sticky top-0 h-screen w-1/4 border-r border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800">
          ...
          <div className="flex items-center text-primary-900 dark:text-primary-600">
            <FaStore className="mr-2 " />
            <a href="/marketplace/store">My Store</a>
            {/* Hide Filters */}
            <button className="ml-auto" onClick={toogleFilters}>
              <FaWindowClose />
            </button>
          </div>
          <hr className="my-4" />
          ...
          <div className="mt-12 flex flex-col gap-3">
            <h3 className="text-2xl font-bold text-primary-950 dark:text-primary-600 underline underline-offset-4">
              Filters
            </h3>

            <div className="relative w-full mt-4 flex flex-col">
              <h5 className="text-lg font-semibold text-primary-950 dark:text-primary-700">Sort</h5>
              <select
                className="w-full  text-primary-800 dark:text-primary-600 py-2 px-4 rounded-lg mt-2 bg-gray-200 dark:bg-gray-600 hover:bg-gray-200"
                value={filters.sort}
                onChange={(e) =>
            ...
            <div className="relative w-full mt-6 flex flex-col">
              <h5 className="text-lg font-semibold text-primary-950 dark:text-primary-700">
                Categories
              </h5>
            ...
            <div className="relative w-full mt-6 flex flex-col">
              <h5 className="text-lg font-semibold text-primary-950 dark:text-primary-700">Price</h5>
              <p className="text-sm my-2 text-primary-700">
                PKR {formatAmount(Number(filters.price))}
              </p>
              <input
                type="range"
                step="1"
            ...
            <button
              className="bg-red-800 text-white py-2 px-4 rounded-lg w-full  hover:bg-red-900 mt-8"
              onClick={() => {
                setSearch("");
                setFilters({
                  ...filters,
        ...
        <div className="container mx-auto p-4">
          <header className="flex justify-between items-center mb-5 flex-col sm:flex-row">
            ...
            <div className="md:block flex gap-3">
              {!showFilters && (
                <button
                  className=" flex justify-center items-center w-max md:w-full px-4 py-2 text-sm font-semibold text-center text-white transition-colors duration-200 transform bg-primary-600 rounded-md hover:bg-primary-700 focus:outline-none focus:bg-primary-700"
