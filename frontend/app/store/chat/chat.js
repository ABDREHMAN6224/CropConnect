...
export const GetCreateChat = createAsyncThunk('chat/createChat',async (data,thunkAPI) => {
    try {
...
export const deleteChat = createAsyncThunk('chat/deleteChat',async (id,thunkAPI) => {
    try {
...
export const leaveChat = createAsyncThunk('chat/leaveChat',async (id,thunkAPI) => {
    try {
