                ...
                <div className="mt-2 w-full">
                    <div className="flex w-full h-96">
                            <div className="flex flex-1  h-full overflow-hidden">
                                {blog.files && blog.files[activeImage] && isVideo(blog.files[activeImage]) ? (
                                    <video className="object-contain object-center rounded w-full h-full" autoPlay loop controls>
                                        <source src={blog.files[activeImage]} type="video/mp4"/>
                                        <source src={blog.files[activeImage]} type="video/ogg"/>
                                        <source src={blog.files[activeImage]} type="video/webm"/>
                                        Your browser does not support the video tag.
                                    </video>
                                ) :
                                <img alt="crop" className="object-contain object-center rounded flex-1 w-full h-full" src={blog.files && blog.files[activeImage]} />
                                }
                            </div>
