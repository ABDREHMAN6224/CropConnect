...
const HomePageHeroSection = ({isAdmin}) => {
  return (
    <section className={`relative ${isAdmin ? "md:py-80 py-96 md:pb-60 ":"py-44 md:py-44"} xl:pb-96 xl:py-96  text-white overflow-hidden section-bg lg:px-44 md:px-32  pb-16 px-8 sm:px-24 sm:pb-32`}>
