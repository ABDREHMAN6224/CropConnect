                    ...
                    <div className="mt-4">
                      ...
                      <div className="mt-2">
                        ...
                        {review.length < 4 && review.length > 0 && (
                          <p className="text-xs text-red-500">Review must be at least 4 characters</p>
                        )}
                      </div>
                      ...
                      <div className="mt-4">
                          ...
                          {[...Array(5)].map((star, i) => {
                            ...
                            return (
                              <label key={i}>
                                ...
                                <FaStar
                                  className="star"
                                  color={ratingValue <= rating ? "#ffc107" : "#d2d3d6"}
                                  size={20}
                                />
                              </label>
                            );
                        ...
                        <div className="mt-2">
                          <button className="bg-primary-600 text-white py-2 px-4 rounded-lg w-full mt-4 hover:bg-primary-700 disabled:opacity-50"
